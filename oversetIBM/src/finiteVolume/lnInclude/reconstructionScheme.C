...
)
{
    ...
    //const surfaceScalarField &faceType = mesh.lookupObject<surfaceScalarField>("faceType");
    //const surfaceScalarField &faceDonor = mesh.lookupObject<surfaceScalarField>("faceDonor");
...
//        if (mesh.boundary()[pi].name() == "oversetPatch")
//        {
//            forAll(mesh.boundary()[pi], fi)
//            {
//                sfbf_L[pi] = vfi[faceDonor.boundaryField()[pi][fi]];
//                sfbf_R[pi] = sfbf_L[pi];
//            }
//        } else if (vf.boundaryField()[pi].coupled())
