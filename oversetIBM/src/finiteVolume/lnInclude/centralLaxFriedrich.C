...
defineTypeNameAndDebug(centralLaxFriedrich, 0);
addToRunTimeSelectionTable(jacobianInviscid, centralLaxFriedrich, dictionary);


// * * * * * * * * * * * * * Constructor * * * * * * * * * * * * * * * * * * //

centralLaxFriedrich::centralLaxFriedrich
(
...
// flux terms.
void centralLaxFriedrich::addFluxTerms(compressibleJacobianMatrix& jacobian)
{
...
void centralLaxFriedrich::boundaryJacobian
(
    label patchi,
...
void centralLaxFriedrich::addTemporalTerms(compressibleJacobianMatrix& jacobian)
{
...
void centralLaxFriedrich::addInviscidJacobian(compressibleJacobianMatrix& jacobian)
{
