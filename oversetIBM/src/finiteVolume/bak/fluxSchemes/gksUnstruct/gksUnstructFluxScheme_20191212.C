...
*/
	    ...
	    if (pt < (mesh_.faces()[iface].size()-1))
            {
	        x1= (mesh_.points()[mesh_.faces()[iface][pt]] + mesh_.points()[mesh_.faces()[iface][pt+1]])/2-face_center;
	        x2= (mesh_.points()[mesh_.faces()[iface][pt]] - mesh_.points()[mesh_.faces()[iface][pt+1]])/2;
            } else {
	        x1= (mesh_.points()[mesh_.faces()[iface][pt]] + mesh_.points()[mesh_.faces()[iface][0]])/2-face_center;
	        x2= (mesh_.points()[mesh_.faces()[iface][pt]] - mesh_.points()[mesh_.faces()[iface][0]])/2;
            }
	    length = Foam::min(length, Foam::min(mag(x1), mag(x2)));
        }
...
*/
		    ...
		    forAll(mesh_.faces()[faceLabel],pt)
	                ...
	                if (pt < (mesh_.faces()[faceLabel].size()-1))
                        {
	                    x1= (mesh_.points()[mesh_.faces()[faceLabel][pt]]+mesh_.points()[mesh_.faces()[faceLabel][pt+1]])/2 - face_center;
	                    x2= (mesh_.points()[mesh_.faces()[faceLabel][pt]]-mesh_.points()[mesh_.faces()[faceLabel][pt+1]])/2;
                        } else {
	                    x1= (mesh_.points()[mesh_.faces()[faceLabel][pt]]+mesh_.points()[mesh_.faces()[faceLabel][0]])/2 - face_center;
	                    x2= (mesh_.points()[mesh_.faces()[faceLabel][pt]]-mesh_.points()[mesh_.faces()[faceLabel][0]])/2;
                        }
	                length = Foam::min(length, Foam::min(mag(x1),mag(x2)));
                    }
		    //Get cell center
