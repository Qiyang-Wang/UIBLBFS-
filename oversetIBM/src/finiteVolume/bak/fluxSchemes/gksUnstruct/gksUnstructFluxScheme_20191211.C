...
*/
	    ...
	    if (pt < (mesh_.faces()[iface].size()-1))
            {
	        x2= (mesh_.points()[mesh_.faces()[iface][pt]] - mesh_.points()[mesh_.faces()[iface][pt+1]]);
            } else {
	        x2= (mesh_.points()[mesh_.faces()[iface][pt]] - mesh_.points()[mesh_.faces()[iface][0]]);
            }
	    length = Foam::min(length, mag(x2));
        }
...
*/
	                ...
	                if (pt < (mesh_.faces()[faceLabel].size()-1))
                        {
	                    x2= (mesh_.points()[mesh_.faces()[faceLabel][pt]]-mesh_.points()[mesh_.faces()[faceLabel][pt+1]]);
                        } else {
	                    x2= (mesh_.points()[mesh_.faces()[faceLabel][pt]]-mesh_.points()[mesh_.faces()[faceLabel][0]]);
                        }
	                length = Foam::min(length, mag(x2));
                    }
		    //Get cell center
